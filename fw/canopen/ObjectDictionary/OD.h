...
********************************************************************************
    ...
    File info:
        ...
        Project File: MoteusJoint.xdd
        File Version: 1

        Created:      11/06/2025 12:01:18
        Created By:   Joshua Smith
        Modified:     01/09/2026 00:00:00
        Modified By:

    Device Info:
        Vendor Name:  Kinisi
        Vendor ID:    0x00003000
        Product Name: moteus
        Product ID:   0x00000020
...
/* TPDO1-4 (0x1800-0x1803) carry host-mapped motor telemetry.  The moteus has
 * no IMU, so there are no firmware-owned sensor TPDOs. */
...
typedef struct {
    ...
    float32_t x6001_commandPosition;
    uint8_t x6011_nodeID;
    uint32_t x6016_productCode;
    uint32_t x6017_vendorId;
    uint8_t x6018_shortestPathDisabled;
    uint8_t x6019_bootCalibration;
    float32_t x601B_homePosition;
    uint8_t x601C_dynamixelPresent;
    uint32_t x601E_hardwareRevision;
} OD_PERSIST_COMM_t;
...
typedef struct {
    ...
    bool_t x2000_bootloader;
    uint8_t x6000_updateMode;
    float32_t x6002_commandVelocity;
    float32_t x6003_commandCurrent;
    float32_t x6004_position;
    float32_t x6005_velocity;
    float32_t x6006_current;
    uint8_t x6007_controlWord;
    uint8_t x6008_statusWord;
    int32_t x6009_errorCode;
    uint32_t x6010_maxVelocity;
    uint8_t x6012_controlMode;
    uint8_t x6013_LEDControlWord;
    float32_t x6014_currentLimit;
    float32_t x6015_temperature;
    uint8_t x601A_persistTrigger;
} OD_RAM_t;
...
#define OD_ENTRY_H6002 &OD->list[36]
#define OD_ENTRY_H6003 &OD->list[37]
#define OD_ENTRY_H6004 &OD->list[38]
#define OD_ENTRY_H6005 &OD->list[39]
#define OD_ENTRY_H6006 &OD->list[40]
#define OD_ENTRY_H6007 &OD->list[41]
#define OD_ENTRY_H6008 &OD->list[42]
#define OD_ENTRY_H6009 &OD->list[43]
#define OD_ENTRY_H6010 &OD->list[44]
#define OD_ENTRY_H6011 &OD->list[45]
#define OD_ENTRY_H6012 &OD->list[46]
#define OD_ENTRY_H6013 &OD->list[47]
#define OD_ENTRY_H6014 &OD->list[48]
#define OD_ENTRY_H6015 &OD->list[49]
#define OD_ENTRY_H6016 &OD->list[50]
#define OD_ENTRY_H6017 &OD->list[51]
#define OD_ENTRY_H6018 &OD->list[52]
#define OD_ENTRY_H6019 &OD->list[53]
#define OD_ENTRY_H601A &OD->list[54]
#define OD_ENTRY_H601B &OD->list[55]
#define OD_ENTRY_H601C &OD->list[56]
#define OD_ENTRY_H601E &OD->list[57]
...
#define OD_ENTRY_H2000_bootloader &OD->list[33]
#define OD_ENTRY_H6000_updateMode &OD->list[34]
#define OD_ENTRY_H6001_commandPosition &OD->list[35]
#define OD_ENTRY_H6002_commandVelocity &OD->list[36]
#define OD_ENTRY_H6003_commandCurrent &OD->list[37]
#define OD_ENTRY_H6004_position &OD->list[38]
#define OD_ENTRY_H6005_velocity &OD->list[39]
#define OD_ENTRY_H6006_current &OD->list[40]
#define OD_ENTRY_H6007_controlWord &OD->list[41]
#define OD_ENTRY_H6008_statusWord &OD->list[42]
#define OD_ENTRY_H6009_errorCode &OD->list[43]
#define OD_ENTRY_H6010_maxVelocity &OD->list[44]
#define OD_ENTRY_H6011_nodeID &OD->list[45]
#define OD_ENTRY_H6012_controlMode &OD->list[46]
#define OD_ENTRY_H6013_LEDControlWord &OD->list[47]
#define OD_ENTRY_H6014_currentLimit &OD->list[48]
#define OD_ENTRY_H6015_temperature &OD->list[49]
#define OD_ENTRY_H6016_productCode &OD->list[50]
#define OD_ENTRY_H6017_vendorId &OD->list[51]
#define OD_ENTRY_H6018_shortestPathDisabled &OD->list[52]
#define OD_ENTRY_H6019_bootCalibration &OD->list[53]
#define OD_ENTRY_H601A_persistTrigger &OD->list[54]
#define OD_ENTRY_H601B_homePosition &OD->list[55]
#define OD_ENTRY_H601C_dynamixelPresent &OD->list[56]
#define OD_ENTRY_H601E_hardwareRevision &OD->list[57]
